...
public class Main
{
      ...
      public static final String ASCII_ART_0 = "    .----.    .----.  ",
        ...
        public static final String TITLE_EAC = "EMPLOYMENT AUTHORIZATION CARD";
...

    {
        ...
        cardNum = UtilityBelt.readString("Enter card #: ", 0, 13);
        ...
        expireYear = UtilityBelt.readInt("Enter expiration year: ", 1000, 9999);
        ...
        //OUTPUT SECTION
        Main.formatCard(surname, givenName, category, cardNum, birthCountry, termsAndConditions, 
